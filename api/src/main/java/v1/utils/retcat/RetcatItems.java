...
public class RetcatItems {
    ...
    public static List<RetcatItem> getAllRetcatItems() throws IOException, RepositoryException, MalformedQueryException, QueryEvaluationException, SesameSparqlException, ResourceNotAvailableException {
        ...
        retcatList.add(new RetcatItem("Getty TGN",
                ...
                "/v1/retcat/query/getty/tgn", "/v1/retcat/info/getty", "//vocab.getty.edu", "common reference thesauri (CH)", "getty", "en", "high"));
        retcatList.add(new RetcatItem("Getty ULAN",
                ...
                "/v1/retcat/query/getty/ulan", "/v1/retcat/info/getty", "//vocab.getty.edu", "common reference thesauri (CH)", "getty", "en", "high"));
        // HERITAGE DATA
        ...
        retcatList.add(new RetcatItem("Heritage Data RCAHMS",
                ...
                "/v1/retcat/query/heritagedata/rcahms", "/v1/retcat/info/heritagedata", "//purl.org/heritagedata/schemes", "common reference thesauri (CH)", "heritagedata", "en", "high"));
        retcatList.add(new RetcatItem("Heritage Data RCAHMW",
                ...
                "/v1/retcat/query/heritagedata/rcahmw", "/v1/retcat/info/heritagedata", "//purl.org/heritagedata/schemes", "common reference thesauri (CH)", "heritagedata", "en", "high"));
        // CHRONONTOLOGY
        retcatList.add(new RetcatItem("ChronOntology",
                ...
                "/v1/retcat/query/chronontology", "/v1/retcat/info/chronontology", "//chronontology.dainst.org/period", "common reference thesauri (CH)", "chronontology", "en", "high"));
        ...
        retcatList.add(new RetcatItem("Pleiades",
                ...
                "/v1/retcat/query/pelagiospleiadesplaces", "/v1/retcat/info/pelagiospleiadesplaces", "//pleiades.stoa.org/places", "common reference thesauri (CH)", "pleiades", "en", "high"));
        // SKOSMOS
        retcatList.add(new RetcatItem("FINTO - Finnish Thesaurus and Ontology Service",
                ...
                "/v1/retcat/query/skosmos/finto", "/v1/retcat/info/skosmos/finto", "//www.yso.fi", "other reference thesauri", "finto", "en", "low"));
        retcatList.add(new RetcatItem("FAO - AGROVOC Multilingual agricultural thesaurus",
                ...
                "/v1/retcat/query/skosmos/fao", "/v1/retcat/info/skosmos/fao", "//aims.fao.org", "other reference thesauri", "fao", "en", "low"));
        retcatList.add(new RetcatItem("UNESCO Thesaurus",
                ...
                "/v1/retcat/query/skosmos/unesco", "/v1/retcat/info/skosmos/unesco", "//vocabularies.unesco.org", "other reference thesauri", "unesco", "en", "high"));
        ...
        retcatList.add(new RetcatItem("DBpedia",
                ...
                "/v1/retcat/query/dbpedia", "/v1/retcat/info/html", "//dbpedia.org/resource", "additional information", "dbpedia", "de", "low"));
        // GEONAMES
